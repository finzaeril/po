    ...
    * { box-sizing: border-box; }
    ...
    .watermark {
      ...
      box-shadow:
        ...
        0 0 34px rgba(157, 123, 255, 0.22);
      text-shadow: 0 0 10px rgba(124, 77, 255, 0.20);
      user-select: none;
      animation: watermarkGlow 2.8s ease-in-out infinite alternate;
    }
    ...
    @keyframes watermarkGlow {
      from {
        box-shadow:
          ...
          0 0 24px rgba(157, 123, 255, 0.14);
      }
      to {
        box-shadow:
          0 0 0 1px rgba(124, 77, 255, 0.16),
          0 0 18px rgba(124, 77, 255, 0.24),
          0 0 44px rgba(157, 123, 255, 0.28);
      }
    }
    ...
    @media (max-width: 920px) {
      ...
      .watermark { top: auto; bottom: 16px; left: 16px; right: auto; }
    }
  </style>
</head>
<body>
